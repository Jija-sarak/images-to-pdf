...
def image_conversion(inpath,image_path):
  ...
  for image in pil_images :
    ...
    if i >8 :
        if i%2==0:
            ...
            rotated_image = img.transpose(Image.ROTATE_90)
            rotated_image.save(image_path+"/"+Name+str(i)+".jpg")
            img1= Image.open(image_path+"/"+Name+str(i)+".jpg")
            list2.append(img1)
        else :
            img = Image.open(image_path+"/"+Name+str(i)+".jpg")
  ...
  get_concat_tile_resize([[list2[0], list2[1]],
                          [list2[-1], list2[-2]]]).save(image_path+'/'+Name+'1.png')
  get_concat_tile_resize([[list1[1], list1[0]],
                          [list1[-2], list1[-1]]]).save(image_path+'/'+Name+'2.png')
  get_concat_tile_resize([[list2[2], list2[3]],
                          [list2[-3], list2[-4]]]).save(image_path+'/'+Name+'3.png')
  get_concat_tile_resize([[list1[3], list1[2]],
                          [list1[-4], list1[-3]]]).save(image_path+'/'+Name+'4.png')

  # Incerting 4 images to one pdf
  def imgToPDF():
        image_1 = Image.open(image_path+'/'+Name+'1.png')
        image_2 = Image.open(image_path+'/'+Name+'2.png')
        image_3 = Image.open(image_path+'/'+Name+'3.png')
        image_4 = Image.open(image_path+'/'+Name+'4.png')
        ...
        im_1.save(image_path+'/'+Name+'_1.pdf', save_all=True, append_images=image_list)
